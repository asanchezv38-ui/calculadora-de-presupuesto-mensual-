...
Automatizar el proceso de cálculo del balance (RF3).

Mejorar la planificación presupuestaria del usuario a través de datos históricos (RF4).

Garantizar la integridad y protección de los datos financieros (RF5 y RNF3).

Ofrecer una experiencia intuitiva (RNF1) para el registro diario de transacciones.
